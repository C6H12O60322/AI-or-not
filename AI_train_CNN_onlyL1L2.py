...
def build_VGG16_model(input_shape, l1_value=0.01, l2_value=0.0001):
...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.3, patience=2, min_lr=0.00001) #factor=0.2, patience=5, min_lr=0.00001
